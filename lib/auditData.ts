...
export const auditCategories: AuditCategory[] = [
  ...
  // ============================================
  {
    ...
    points: [
      ...
      { id: 18, category: 'service', categoryAr: 'الخدمة', question: 'Delivery Handoff: Orders handed to delivery drivers within 2 minutes? Bags sealed properly? Temperature maintained?', questionAr: 'تسليم التوصيل: الطلبات مسلمة لسائق التوصيل خلال دقيقتين؟', maxScore: 2, priority: 'STANDARD' },
