...
export const auditCategories: AuditCategory[] = [
  ...
  // ============================================
  {
    ...
    points: [
      ...
      { id: 13, category: 'service', categoryAr: 'الخدمة', question: 'CONNECT Method: Staff use CONNECT - Confirm, Offer additions, Note requests, Connect personally, Express thanks?', questionAr: 'طريقة CONNECT: تأكيد، عرض الإضافات، ملاحظة الطلبات، التواصل شخصياً، أظهر الشكر؟', maxScore: 2, priority: 'STANDARD' },
  ...
  // ============================================
  {
    ...
    points: [
      ...
      { id: 18, category: 'service', categoryAr: 'الخدمة', question: 'Delivery Handoff: Orders handed to delivery drivers within 2 minutes? Bags sealed properly? Temperature maintained?', questionAr: 'تسليم التوصيل: الطلبات递给 لسائق التوصيل خلال دقيقتين؟', maxScore: 2, priority: 'STANDARD' },
      ...
      { id: 37, category: 'safety', categoryAr: 'السلامة', question: 'Fire Safety: Extinguisher accessible? Exits clear? Evacuation plan posted?', questionAr: 'السلامة من الحرائق: extinguisher متاح؟ المخارج واضحة؟', maxScore: 2, priority: 'STANDARD' },
      { id: 38, category: 'safety', categoryAr: 'السلامة', question: 'Chemical Storage: Chemicals stored separately from food? Proper labels? Safety data sheets available?', questionAr: 'تخزين المواد الكيميائية: المواد الكيميائية منفصلة عن الطعام؟', maxScore: 2, priority: 'STANDARD' },
      { id: 39, category: 'safety', categoryAr: 'السلامة', question: 'First Aid: Kit stocked? Expired items replaced? Staff know location?', questionAr: 'الإسعافات الأولية: صندوق مُجهز؟ العناصر منتهية الاستبدال؟', maxScore: 2, priority: 'STANDARD' },
