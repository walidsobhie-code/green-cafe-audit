...
export const auditCategories: AuditCategory[] = [
  ...
  // ============================================
  {
    ...
    points: [
      ...
      { id: 25, category: 'beverage', categoryAr: 'المشروبات', question: 'Recipe Adherence: Every drink made exactly according to standard recipe card - correct shots, milk, syrup, ice, temperature?', questionAr: 'الالتزام بالوصفة: كل مشروب مصنوع تماماً حسب بطاقة الوصفة - شوتات صحيحة، حليب، شراب، ثلج، حرارة؟', maxScore: 2, priority: 'STANDARD' },
